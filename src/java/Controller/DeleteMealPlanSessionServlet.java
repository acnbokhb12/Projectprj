 ...
 * @author DELL
 */
public class DeleteMealPlanSessionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            wld.deleteFoodFromMealPlan(accid, Integer.parseInt(fid), date);
            session.setAttribute("dateFood", mealMap);
            request.setAttribute("deldate", date);
            request.setAttribute("FOODID", fid);
