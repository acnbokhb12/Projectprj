 ...
 * @author DELL
 */
public class ManageWeeklyMenuServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(wm!=null){
                request.setAttribute("WeekMenu", wm);
                request.getRequestDispatcher("ControllerServlet?action="+IConstant.WEEKLYMAINJSP).forward(request, response);                
            }else{
